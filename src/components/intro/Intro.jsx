...
function Intro() {
    return (
        <div className='w-full bg-[#eeeeee] pt-4 lg:pt-0'>
            <div className='flex items-center justify-center flex-wrap gap-5 bg-white py-10 mx-auto my-0 rounded w-[800px] lg:w-full lg:py-6'>
